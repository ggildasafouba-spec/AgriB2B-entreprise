    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-700 via-green-800 to-emerald-900 text-white">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-emerald-400 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm mb-6 animate-fade-in">
              <span className="w-2 h-2 bg-green-400 rounded-full animate-ping" />
              <span>Nouvelles annonces publiées chaque jour</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-green-100 mb-8 max-w-2xl">
              Connectez producteurs, acheteurs et transporteurs. Paiement sécurisé Mobile Money. Livraison avec suivi en temps réel.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="/register" className="px-8 py-4 bg-white text-green-800 rounded-xl font-bold text-lg hover:bg-green-50 transition shadow-lg hover:shadow-xl">
                Commencer gratuitement
              </Link>
              <Link href="/dashboard/products" className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/30 rounded-xl font-medium text-lg hover:bg-white/20 transition">
                Voir les produits →
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 mt-16 max-w-lg">
            <div className="text-center">
              ...
              <p className="text-sm text-green-200">Utilisateurs</p>
            </div>
            <div className="text-center">
